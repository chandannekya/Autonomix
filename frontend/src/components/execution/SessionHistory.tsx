  ...
  return (
    <div className="space-y-2 p-4">
      ...
      {runs.map((run: AgentRun) => (
        <div
          key={run.id}
          className="border border-border-soft rounded-lg p-3 bg-bg-primary space-y-1"
        >
          {/* Task */}
          ...
          {/* Answer preview */}
          <div className="pl-4 font-mono text-[11px] text-text-muted leading-relaxed line-clamp-2">
            {run.response.slice(0, 120)}
